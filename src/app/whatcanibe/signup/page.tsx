    ...
    <div className="min-h-screen bg-background flex items-center justify-center px-6 relative overflow-hidden">
      ...
      >
        <div className="text-center mb-10">
          ...
          <p className="text-muted-foreground font-bold text-lg">Join the next generation of professionals.</p>
        </div>
        ...
        <GlowCard className="p-10 border-border bg-card/50 backdrop-blur-xl rounded-[2.5rem] shadow-2xl">
          <div className="mb-10">
            ...
            <p className="text-base text-muted-foreground font-medium mt-2">Start your career discovery journey today.</p>
          </div>
          ...
          <form onSubmit={handleSignup} className="space-y-6">
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="w-full h-16 bg-primary hover:bg-primary/90 text-primary-foreground rounded-2xl font-black text-xl group transition-all shadow-xl shadow-primary/20 mt-4"
            >
              {isLoading ? (
          ...
          <div className="mt-10 pt-10 border-t border-border text-center">
            <p className="text-base text-muted-foreground font-medium">
              ...
              <Link href="/whatcanibe/login" className="text-primary font-black hover:text-primary/80 transition-colors">
                Log in
              </Link>
            </p>
          </div>
