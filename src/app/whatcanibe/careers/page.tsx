...
export default function CareersPage() {
  return (
    <div className="min-h-screen pt-24 pb-20 overflow-hidden relative bg-background">
      {/* Careers Atmosphere */}
      <div className="absolute top-0 left-0 w-full h-[1000px] bg-[radial-gradient(circle_at_20%_20%,rgba(79,70,229,0.05),transparent_50%)] pointer-events-none" />
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-zinc-200 bg-zinc-50 text-zinc-950 text-[10px] font-bold uppercase tracking-[0.2em] mb-12 shadow-sm">
            <Sparkles className="h-3 w-3 text-indigo-600" />
            Discover Your Potential
          </div>
          <h1 className="text-6xl md:text-8xl lg:text-[10rem] font-bold text-zinc-950 mb-10 tracking-tighter leading-[0.85]">
            Explore <br />
            <motion.span
          ...
          <p className="text-zinc-600 text-lg md:text-2xl max-w-2xl leading-relaxed font-medium mb-12">
