  ...
  return (
    <div className="min-h-screen pt-24 pb-20 px-6 bg-background">
      <div className="container mx-auto max-w-4xl">
        <Link
          href="/whatcanibe/dashboard/mentor"
        ...
        <div className="mb-12">
          <div className="flex items-center gap-2 text-indigo-600 text-sm font-bold mb-3 uppercase tracking-widest">
            ...
            {isNewMentor ? "Mentor Onboarding" : "Profile Management"}
          </div>
          <h1 className="text-4xl font-bold text-zinc-900 tracking-tight">
            {isNewMentor ? "Build Your" : "Manage"} <span className="bg-gradient-to-r from-indigo-600 to-blue-600 bg-clip-text text-transparent">Professional Identity.</span>
          </h1>
