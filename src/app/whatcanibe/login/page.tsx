    ...
    <div className="min-h-screen bg-white dark:bg-background flex items-center justify-center px-4 md:px-6 relative overflow-hidden transition-colors duration-500">
      ...
      >
        <div className="text-center mb-10">
          ...
          <p className="dark:text-zinc-500 text-zinc-400 font-bold tracking-tight">The protocol for your professional evolution.</p>
        </div>
        ...
        <GlowCard className="p-8 md:p-10 glass border-zinc-100 dark:border-white/10 rounded-[2.5rem] shadow-2xl relative overflow-hidden group">
          <div className="absolute -top-24 -right-24 h-48 w-48 bg-brand-primary/10 blur-[60px] rounded-full group-hover:bg-brand-primary/20 transition-colors" />
          ...
          <div className="mb-10 relative">
            ...
            <p className="text-sm dark:text-zinc-500 text-zinc-400 mt-2 font-bold leading-relaxed">Enter your credentials to resume your journey.</p>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-6 relative">
            ...
            <div className="space-y-2">
              <div className="flex items-center justify-between ml-1">
                <label className="text-[10px] font-black dark:text-zinc-500 text-zinc-400 uppercase tracking-widest">Passcode</label>
                <Link href="#" className="text-[10px] font-black text-brand-primary hover:text-brand-vibrant uppercase tracking-widest transition-colors">Forgot Keys?</Link>
              </div>
              <div className="relative group/input">
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="w-full h-16 bg-brand-primary hover:bg-brand-primary/90 text-white rounded-2xl font-black text-lg group transition-all shadow-xl shadow-brand-primary/20 active:scale-[0.98]"
            >
              {isLoading ? (
          ...
          <div className="mt-10 pt-8 border-t border-zinc-100 dark:border-white/5 text-center relative">
            <p className="text-sm dark:text-zinc-500 text-zinc-400 font-bold">
              New to the protocol?{" "}
              <Link href="/whatcanibe/signup" className="text-brand-primary font-black hover:text-brand-vibrant transition-colors underline decoration-2 underline-offset-4">
                Register Now
              </Link>
            </p>
          </div>
