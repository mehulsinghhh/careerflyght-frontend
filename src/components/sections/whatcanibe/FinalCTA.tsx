  ...
  return (
    <section id="final-cta" className="py-40 px-6 relative overflow-hidden">
      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full border border-white/10 bg-white/5 text-white text-[10px] font-black uppercase tracking-[0.3em] mb-12">
            <Sparkles className="h-4 w-4" />
            Global Protocol Access
          </div>

          <h2 className="text-5xl md:text-8xl font-bold tracking-tighter mb-10 leading-[0.85] text-white">
            Secure Your <br />
            <span className="italic text-zinc-500">Professional Fate.</span>
          </h2>
          ...
          <div className="mt-16 flex items-center justify-center gap-4">
             <div className="flex -space-x-3">
                {[1,2,3,4].map(i => (
                  <div key={i} className="w-10 h-10 rounded-full border-2 border-black bg-zinc-800 flex items-center justify-center text-[10px] font-bold text-white uppercase">
                    U{i}
                  </div>
                ))}
                <div className="w-10 h-10 rounded-full border-2 border-black bg-zinc-800 flex items-center justify-center text-[10px] font-bold text-white uppercase">
                   +2k
                </div>
             </div>
